...
var ResizeableEvent = class extends Event {
  x = 0;
  y = 0;
  width = 0;
  height = 0;
...
var ResizeableResizeStartEvent = class extends ResizeableEvent {
  constructor(rect, options) {
    super("resize-start", rect, options);
  }
};
var ResizeableResizeEvent = class extends ResizeableEvent {
  constructor(rect, options) {
    super("resize", rect, options);
  }
};
var ResizeableResizeEndEvent = class extends ResizeableEvent {
  constructor(rect, options) {
    super("resize-end", rect, options);
  }
};
var ResizeableComponent = class extends DraggableComponent {
  static css = DraggableComponent.css + css2;
  ...
  static template = DraggableComponent.template + template2;
  _height = 0;
  _width = 0;
  _x = 0;
  _y = 0;
