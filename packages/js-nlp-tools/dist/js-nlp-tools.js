(() => {
  ...
  var require_clean = __commonJS({
    "src/utils/clean.js"(exports, module) {
...
`);
  ...
  // src/utils/two-norm.js
  var require_two_norm = __commonJS({
    "src/utils/two-norm.js"(exports, module) {
      var { dot } = require_src();
      function twoNorm(x) {
  ...
  var require_cosine_similarity = __commonJS({
    "src/utils/cosine-similarity.js"(exports, module) {
      var { clamp, dot } = require_src();
      var twoNorm = require_two_norm();
  ...
  // src/utils/get-size.js
  var require_get_size = __commonJS({
    "src/utils/get-size.js"(exports, module) {
  ...
  // src/utils/is-whole-number.js
  var require_is_whole_number2 = __commonJS({
    "src/utils/is-whole-number.js"(exports, module) {
      function isWholeNumber(x) {
  ...
  // src/utils/safe-delete.js
  var require_safe_delete = __commonJS({
    "src/utils/safe-delete.js"(exports, module) {
      var { fs } = (() => {
        try {
          return {
      ...
      var WE_ARE_IN_THE_BROWSER = isBrowser();
  ...
  // src/utils/safe-path-join.js
  var require_safe_path_join = __commonJS({
    "src/utils/safe-path-join.js"(exports, module) {
      var { path } = (() => {
        try {
          return {
  ...
  // src/utils/safe-read.js
  var require_safe_read = __commonJS({
    "src/utils/safe-read.js"(exports, module) {
      var { fs } = (() => {
        try {
          return {
            fs: __require("node:fs")
  ...
  // src/utils/safe-write.js
  var require_safe_write = __commonJS({
    "src/utils/safe-write.js"(exports, module) {
      var { fs } = (() => {
        try {
          return {
            fs: __require("node:fs")
  ...
  // src/utils/string-set.js
  var require_string_set = __commonJS({
    "src/utils/string-set.js"(exports, module) {
  ...
  var require_utils = __commonJS({
    "src/utils/index.js"(exports, module) {
      module.exports = {
        clean: require_clean(),
        cosineSimilarity: require_cosine_similarity(),
        getSize: require_get_size(),
        isWholeNumber: require_is_whole_number2(),
        safeDelete: require_safe_delete(),
        safePathJoin: require_safe_path_join(),
        safeRead: require_safe_read(),
        safeWrite: require_safe_write(),
        StringSet: require_string_set(),
        twoNorm: require_two_norm()
      };
    }
  });

  // node_modules/@jrc03c/js-type-experiments/src/create-type.js
  var require_create_type = __commonJS({
    "node_modules/@jrc03c/js-type-experiments/src/create-type.js"(exports, module) {
      var { pascalify } = require_src2();
  ...
  // node_modules/@jrc03c/js-type-experiments/src/is-of-type.js
  var require_is_of_type = __commonJS({
    "node_modules/@jrc03c/js-type-experiments/src/is-of-type.js"(exports, module) {
      var { isDate } = require_src();
  ...
  // node_modules/@jrc03c/js-type-experiments/src/create-typed-array.js
  var require_create_typed_array = __commonJS({
    "node_modules/@jrc03c/js-type-experiments/src/create-typed-array.js"(exports, module) {
      var { flatten, isArray } = require_src();
      var { pascalify } = require_src2();
      var isOfType = require_is_of_type();
  ...
  // node_modules/@jrc03c/js-type-experiments/src/define-typed-property.js
  var require_define_typed_property = __commonJS({
    "node_modules/@jrc03c/js-type-experiments/src/define-typed-property.js"(exports, module) {
      var isOfType = require_is_of_type();
  ...
  // node_modules/@jrc03c/js-type-experiments/src/index.js
  var require_src3 = __commonJS({
    "node_modules/@jrc03c/js-type-experiments/src/index.js"(exports, module) {
      var out = {
        createType: require_create_type(),
        createTypedArray: require_create_typed_array(),
        defineTypedProperty: require_define_typed_property(),
        isOfType: require_is_of_type(),
        dump() {
          Object.keys(out).forEach((key) => {
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/camelify.js
  var require_camelify2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/camelify.js"(exports, module) {
      function camelify(text) {
        if (typeof text !== "string") {
          throw new Error("`text` must be a string!");
        }
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/indent.js
  var require_indent2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/indent.js"(exports, module) {
      function indent(text, chars) {
        chars = chars || "";
        return text.split("\n").map((line) => {
          if (line.trim().length > 0) {
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/punctuation.js
  var require_punctuation2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/punctuation.js"(exports, module) {
      module.exports = "!\"#%&'()*+,-./:;<=>?@[]^_`{|}~\xA0\xA1\xA4\xA7\xA9\xAA\xAB\xAE\xB0\xB1\xB6\xB7\xBA\xBB\xBF\xD7\xF7\u0254\u0300\u0301\u0302\u0303\u037E\u0387\u055A\u055B\u055C\u055D\u055E\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061E\u061F\u066A\u066B\u066C\u066D\u06D4\u0700\u0701\u0702\u0703\u0704\u0705\u0706\u0707\u0708\u0709\u070A\u070B\u070C\u070D\u07F7\u07F8\u07F9\u0830\u0831\u0832\u0833\u0834\u0835\u0836\u0837\u0838\u0839\u083A\u083B\u083C\u083D\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04\u0F05\u0F06\u0F07\u0F08\u0F09\u0F0A\u0F0B\u0F0C\u0F0D\u0F0E\u0F0F\u0F10\u0F11\u0F12\u0F14\u0F3A\u0F3B\u0F3C\u0F3D\u0F85\u0FD0\u0FD1\u0FD2\u0FD3\u0FD4\u0FD9\u0FDA\u104A\u104B\u104C\u104D\u104E\u104F\u10FB\u1360\u1361\u1362\u1363\u1364\u1365\u1366\u1367\u1368\u1400\u166E\u169B\u169C\u16EB\u16EC\u16ED\u1735\u1736\u17D4\u17D5\u17D6\u17D8\u17D9\u17DA\u1800\u1801\u1802\u1803\u1804\u1805\u1806\u1807\u1808\u1809\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0\u1AA1\u1AA2\u1AA3\u1AA4\u1AA5\u1AA6\u1AA8\u1AA9\u1AAA\u1AAB\u1AAC\u1AAD\u1B5A\u1B5B\u1B5C\u1B5D\u1B5E\u1B5F\u1B60\u1BFC\u1BFD\u1BFE\u1BFF\u1C3B\u1C3C\u1C3D\u1C3E\u1C3F\u1C7E\u1C7F\u1CC0\u1CC1\u1CC2\u1CC3\u1CC4\u1CC5\u1CC6\u1CC7\u1CD3\u2010\u2011\u2012\u2013\u2014\u2015\u2016\u2017\u2018\u2019\u201A\u201B\u201C\u201D\u201E\u201F\u2020\u2021\u2022\u2023\u2024\u2025\u2026\u2027\u2030\u2031\u2032\u2033\u2034\u2035\u2036\u2037\u2038\u2039\u203A\u203B\u203C\u203D\u203E\u203F\u2040\u2041\u2042\u2043\u2045\u2046\u2047\u2048\u2049\u204A\u204B\u204C\u204D\u204E\u204F\u2050\u2051\u2052\u2053\u2054\u2055\u2056\u2057\u2058\u2059\u205A\u205B\u205C\u205D\u205E\u207D\u207E\u208D\u208E\u2116\u2117\u2120\u2122\u212E\u2212\u2234\u2235\u2248\u2300\u2308\u2309\u230A\u230B\u2311\u2329\u232A\u2380\u25CA\u25CC\u261E\u2640\u2642\u26A5\u2766\u2767\u2768\u2769\u276A\u276B\u276C\u276D\u276E\u276F\u2770\u2771\u2772\u2773\u2774\u2775\u27C5\u27C6\u27E6\u27E7\u27E8\u27E9\u27EA\u27EB\u27EC\u27ED\u27EE\u27EF\u2983\u2984\u2985\u2986\u2987\u2988\u2989\u298A\u298B\u298C\u298D\u298E\u298F\u2990\u2991\u2992\u2993\u2994\u2995\u2996\u2997\u2998\u29D8\u29D9\u29DA\u29DB\u29FC\u29FD\u2CF9\u2CFA\u2CFB\u2CFC\u2CFE\u2CFF\u2D70\u2E00\u2E01\u2E02\u2E03\u2E04\u2E05\u2E06\u2E07\u2E08\u2E09\u2E0A\u2E0B\u2E0C\u2E0D\u2E0E\u2E0F\u2E10\u2E11\u2E12\u2E13\u2E14\u2E15\u2E16\u2E17\u2E18\u2E19\u2E1A\u2E1B\u2E1C\u2E1D\u2E1E\u2E1F\u2E20\u2E21\u2E22\u2E23\u2E24\u2E25\u2E26\u2E27\u2E28\u2E29\u2E2A\u2E2B\u2E2C\u2E2D\u2E2E\u2E30\u2E31\u2E32\u2E33\u2E34\u2E35\u2E36\u2E37\u2E38\u2E39\u2E3A\u2E3B\u2E3C\u2E3D\u2E3E\u2E3F\u2E40\u2E41\u2E42\u2E43\u2E44\u2E45\u2E46\u2E47\u2E48\u2E49\u2E4A\u2E4B\u2E4C\u2E4D\u2E4E\u2E4F\u2E52\u3001\u3002\u3003\u3008\u3009\u300A\u300B\u300C\u300D\u300E\u300F\u3010\u3011\u3014\u3015\u3016\u3017\u3018\u3019\u301A\u301B\u301C\u301D\u301E\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D\uA60E\uA60F\uA673\uA67E\uA6F2\uA6F3\uA6F4\uA6F5\uA6F6\uA6F7\uA874\uA875\uA876\uA877\uA8CE\uA8CF\uA8F8\uA8F9\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1\uA9C2\uA9C3\uA9C4\uA9C5\uA9C6\uA9C7\uA9C8\uA9C9\uA9CA\uA9CB\uA9CC\uA9CD\uA9DE\uA9DF\uAA5C\uAA5D\uAA5E\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uD800\uD801\uD802\uD803\uD804\uD805\uD806\uD807\uD809\uD81A\uD81B\uD82F\uD836\uD83A\u{1F03B}\uDC41\uDC42\uDC43\uDC44\uDC45\uDC47\uDC48\uDC49\uDC4A\uDC4B\uDC4C\uDC4D\uDC4E\uDC4F\uDC57\uDC5A\uDC5B\uDC5D\uDC70\uDC71\uDC72\uDC73\uDC74\uDC9F\uDCBB\uDCBC\uDCBE\uDCBF\uDCC0\uDCC1\uDCC6\uDD00\uDD01\uDD02\uDD1F\uDD2F\uDD3F\uDD40\uDD41\uDD42\uDD43\uDD44\uDD45\uDD46\uDD5E\uDD5F\uDD6F\uDD74\uDD75\uDDC1\uDDC2\uDDC3\uDDC4\uDDC5\uDDC6\uDDC7\uDDC8\uDDC9\uDDCA\uDDCB\uDDCC\uDDCD\uDDCE\uDDCF\uDDD0\uDDD1\uDDD2\uDDD3\uDDD4\uDDD5\uDDD6\uDDD7\uDDDB\uDDDD\uDDDE\uDDDF\uDDE2\uDE38\uDE39\uDE3A\uDE3B\uDE3C\uDE3D\uDE3F\uDE40\uDE41\uDE42\uDE43\uDE44\uDE45\uDE46\uDE50\uDE51\uDE52\uDE53\uDE54\uDE55\uDE56\uDE57\uDE58\uDE60\uDE61\uDE62\uDE63\uDE64\uDE65\uDE66\uDE67\uDE68\uDE69\uDE6A\uDE6B\uDE6C\uDE6E\uDE6F\uDE7F\uDE87\uDE88\uDE89\uDE8A\uDE8B\uDE97\uDE98\uDE99\uDE9A\uDE9B\uDE9C\uDE9E\uDE9F\uDEA0\uDEA1\uDEA2\uDEA9\uDEAD\uDEF0\uDEF1\uDEF2\uDEF3\uDEF4\uDEF5\uDEF6\uDEF7\uDEF8\uDF37\uDF38\uDF39\uDF3A\uDF3B\uDF3C\uDF3D\uDF3E\uDF3F\uDF44\uDF55\uDF56\uDF57\uDF58\uDF59\uDF99\uDF9A\uDF9B\uDF9C\uDF9F\uDFD0\uDFE2\uDFFF\uFD3F\uFE10\uFE11\uFE12\uFE13\uFE14\uFE15\uFE16\uFE17\uFE18\uFE19\uFE30\uFE31\uFE32\uFE33\uFE34\uFE35\uFE36\uFE37\uFE38\uFE39\uFE3A\uFE3B\uFE3C\uFE3D\uFE3E\uFE3F\uFE40\uFE41\uFE42\uFE43\uFE44\uFE45\uFE46\uFE47\uFE48\uFE49\uFE4A\uFE4B\uFE4C\uFE4D\uFE4E\uFE4F\uFE50\uFE51\uFE52\uFE54\uFE55\uFE56\uFE57\uFE58\uFE59\uFE5A\uFE5B\uFE5C\uFE5D\uFE5E\uFE5F\uFE60\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01\uFF02\uFF03\uFF05\uFF06\uFF07\uFF08\uFF09\uFF0A\uFF0C\uFF0D\uFF0E\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B\uFF3C\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F\uFF60\uFF61\uFF62\uFF63\uFF64\uFF65";
    }
  });

  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/replace-all.js
  var require_replace_all2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/replace-all.js"(exports, module) {
      function replaceAll(text, a, b) {
        if (typeof text !== "string") {
          throw new Error("`text` must be a string!");
        }
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/strip.js
  var require_strip2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/strip.js"(exports, module) {
      var punctuation = require_punctuation2();
      var replaceAll = require_replace_all2();
      var doubleSpace = "  ";
      var singleSpace = " ";
      function strip(text) {
        if (typeof text !== "string") {
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/kebabify.js
  var require_kebabify2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/kebabify.js"(exports, module) {
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/convert-object-to-typed-array.js
  var require_convert_object_to_typed_array2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/convert-object-to-typed-array.js"(exports, module) {
      var { isArray } = require_src();
      var context = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : void 0;
      function convertObjectToTypedArray(x) {
        const typedArrayConstructorSymbol = Symbol.for("@TypedArrayConstructor");
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/parse.js
  var require_parse2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/parse.js"(exports, module) {
      var convertObjectToTypedArray = require_convert_object_to_typed_array2();
      var specials = {
        "@Infinity": Infinity,
        "@NegativeInfinity": -Infinity,
        "@NaN": NaN,
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/snakeify.js
  var require_snakeify2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/snakeify.js"(exports, module) {
      var strip = require_strip2();
      function snakeify(text) {
        if (typeof text !== "string") {
          throw new Error("`text` must be a string!");
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/convert-typed-array-to-object.js
  var require_convert_typed_array_to_object2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/helpers/convert-typed-array-to-object.js"(exports, module) {
      var { isArray, isDate } = require_src();
      function convertTypedArrayToObject(x) {
        if (x instanceof ArrayBuffer || x instanceof BigInt64Array || x instanceof BigUint64Array || x instanceof Float32Array || x instanceof Float64Array || x instanceof Int16Array || x instanceof Int32Array || x instanceof Int8Array || x instanceof Uint16Array || x instanceof Uint32Array || x instanceof Uint8Array || x instanceof Uint8ClampedArray) {
          return {
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/stringify.js
  var require_stringify2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/stringify.js"(exports, module) {
      var {
        assert,
        decycle,
        isArray,
      ...
      var convertTypedArrayToObject = require_convert_typed_array_to_object2();
      function prefix(s, n) {
        if (!s || n <= 0)
          return "";
        return range(0, n).map(() => s).join("");
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/unindent.js
  var require_unindent2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/unindent.js"(exports, module) {
      function unindent(text) {
        const lines = text.split("\n");
        const indentations = lines.filter((line) => line.trim().length > 0).map((line) => line.split("").findIndex((char) => !char.match(/\s/g)));
        const minIndentation = Math.min(...indentations);
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/wrap.js
  var require_wrap2 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/wrap.js"(exports, module) {
      function wrap(raw, maxLineLength) {
        if (typeof raw !== "string") {
          throw new Error(
            "The first argument to the `wrap` function must be a string!"
  ...
  // node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/index.js
  var require_src4 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/node_modules/@jrc03c/js-text-tools/src/index.js"(exports, module) {
      var out = {
        camelify: require_camelify2(),
        indent: require_indent2(),
        kebabify: require_kebabify2(),
        parse: require_parse2(),
        snakeify: require_snakeify2(),
        stringify: require_stringify2(),
        unindent: require_unindent2(),
        wrap: require_wrap2(),
        dump() {
          Object.keys(out).forEach((key) => {
            if (typeof global !== "undefined") {
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/errors.js
  var require_errors = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/errors.js"(exports, module) {
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/base-64-decode.js
  var require_base_64_decode = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/base-64-decode.js"(exports, module) {
      var { Base64DecodingError } = require_errors();
      var { isString } = require_src();
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/base-64-encode.js
  var require_base_64_encode = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/base-64-encode.js"(exports, module) {
      var { Base64EncodingError } = require_errors();
      var { isString } = require_src();
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/helpers/is-natural-number.js
  var require_is_natural_number = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/helpers/is-natural-number.js"(exports, module) {
      var { isNumber } = require_src();
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/decrypt.js
  var require_decrypt = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/decrypt.js"(exports, module) {
      var { DecryptionError } = require_errors();
      var { isString } = require_src();
      var { parse } = require_src4();
      var base64Decode = require_base_64_decode();
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/encrypt.js
  var require_encrypt = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/encrypt.js"(exports, module) {
      var { EncryptionError } = require_errors();
      var { isString } = require_src();
      var { stringify } = require_src4();
      var base64Encode = require_base_64_encode();
      var isNaturalNumber = require_is_natural_number();
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/hash.js
  var require_hash = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/hash.js"(exports, module) {
      var { HashingError } = require_errors();
      var { isString, isUndefined } = require_src();
      var { stringify } = require_src4();
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/random-string.js
  var require_random_string = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/random-string.js"(exports, module) {
      var { isString, isUndefined } = require_src();
      var { RandomStringGenerationError } = require_errors();
      var isNaturalNumber = require_is_natural_number();
  ...
  // node_modules/@jrc03c/js-crypto-helpers/src/index.js
  var require_src5 = __commonJS({
    "node_modules/@jrc03c/js-crypto-helpers/src/index.js"(exports, module) {
      var { parse, stringify } = require_src4();
      var JSCryptoHelpers = {
        base64Decode: require_base_64_decode(),
        base64Encode: require_base_64_encode(),
        decrypt: require_decrypt(),
        encrypt: require_encrypt(),
        errors: require_errors(),
        hash: require_hash(),
        parse,
        randomString: require_random_string(),
        stringify,
        dump() {
          Object.keys(JSCryptoHelpers).filter((key) => key !== "dump").forEach((key) => {
  ...
  // src/document/word-count-map.js
  var require_word_count_map = __commonJS({
    "src/document/word-count-map.js"(exports, module) {
      var { isWholeNumber } = require_utils();
  ...
  var require_document = __commonJS({
    "src/document/index.js"(exports, module) {
      var { clean, isWholeNumber, StringSet } = require_utils();
      var {
        createType,
        defineTypedProperty
      } = require_src3();
      var { hash } = require_src5();
      var { set } = require_src();
      var makeKey = require_src6();
      var WordCountMap = require_word_count_map();
      var WholeNumberType = createType("WholeNumber", isWholeNumber);
      var Document = class {
        constructor(data) {
          data = data || {};
        ...
        async index(progress) {
          ...
          allWords.forEach((word, i) => {
            ...
            if (progress)
              progress(0.5 * i / allWords.length);
          });
  ...
  var require_corpus = __commonJS({
    "src/corpus/index.js"(exports, module) {
      var { cosineSimilarity, isWholeNumber, StringSet } = require_utils();
      var {
        createType,
        createTypedArray,
        defineTypedProperty
