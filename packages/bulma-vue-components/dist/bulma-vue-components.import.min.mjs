...
`,q=t({name:"bulma-image",template:k,props:{src:{type:String,required:!1,default:()=>""}},data(){return{css:v}}});export{c as BulmaBlock,f as BulmaBox,b as BulmaButton,y as BulmaDelete,S as BulmaIcon,q as BulmaImage};
