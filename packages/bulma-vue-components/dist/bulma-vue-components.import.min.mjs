function t(e){let o=0,s;e=e||{};let r=e.data?e.data:function(){},n=e.mounted?e.mounted:function(){},i=e.unmounted?e.unmounted:function(){};return r.css||(r.css=""),e.data=function(){return r.bind(this)()},e.mounted=function(){n.bind(this)(),o++;let a=this.$root.$el.getRootNode();a===document&&(a=a.body),s||(s=document.createElement("style"),a.appendChild(s),s.innerHTML=this.css)},e.unmounted=function(){i.bind(this)(),o--;let a=this.$root.$el.getRootNode();if(a===document&&(a=a.body),o<1){if(s)try{a.removeChild(s)}catch{try{s.parentElement.removeChild(s)}catch{}}s=null}},e}typeof window<"u"&&(window.createVueComponentWithCSS=t);var u="",m=`
...
`,V=t({name:"bulma-notification",emits:["close"],components:{"bulma-delete":l},template:w,props:{permanent:{type:Boolean,required:!1,default:()=>!1}},data(){return{css:$}}});var W="",I=`
  <progress :value="value" class="progress" max="1">
    {{ value * 100 }}%
  </progress>
`,L=t({name:"bulma-progress",template:I,props:{value:{type:Number,required:!1,default:()=>0}},data(){return{css:W}}});export{c as BulmaBlock,p as BulmaBox,B as BulmaButton,l as BulmaDelete,x as BulmaIcon,q as BulmaImage,V as BulmaNotification,L as BulmaProgress};
