...
const out = {
  ...
  chop: require("./chop"),
  clamp: require("./clamp"),
  combinations: require("./combinations").combinations,
  combinationsIterator: require("./combinations").combinationsIterator,
  copy,
  ...
  ones: require("./ones"),
  permutations: require("./permutations").permutations,
  permutationsIterator: require("./permutations").permutationsIterator,
  pow: require("./pow"),
  print: require("./print"),
