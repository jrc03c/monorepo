(() => {
  ...
  var NULL_KEY = makeKey2(16);
  var UNDEFINED_KEY = makeKey2(16);
  var INFINITY_KEY = makeKey2(16);
  var MINUS_INFINITY_KEY = makeKey2(16);
  var SYMBOL_KEY = makeKey2(16);
  var Counter = class {
    constructor() {
      this.clear();
    }
  ...
  var NULL_KEY2 = makeKey3(256);
  var UNDEFINED_KEY2 = makeKey3(256);
  var INFINITY_KEY2 = makeKey3(256);
  var MINUS_INFINITY_KEY2 = makeKey3(256);
  var SYMBOL_KEY2 = makeKey3(256);
  function set(arr) {
    if (isDataFrame(arr) || isSeries(arr)) {
  ...
  drone.on("pulse", (request, response) => {
    ...
    setInterval(() => {
      globalThis.postMessage({
        ...
        payload: /* @__PURE__ */ new Date() - start
      });
    }, 10);
    response.send();
  });
