...
function makeKey(n) {
  ...
  let out2 = "";
  while (out2.length < n) out2 += alpha[Math.floor(Math.random() * alpha.length)];
  return out2;
}
...
function ndarray(shape2) {
  ...
  if (shape2.length === 1) {
    const out2 = [];
    for (let i = 0; i < s2; i++) out2.push(void 0);
    return out2;
  } else {
    const out2 = [];
    for (let i = 0; i < s2; i++) {
...
function reverse(arr) {
  ...
  const out2 = [];
  for (let i = arr.length - 1; i >= 0; i--) out2.push(arr[i]);
  return out2;
}
...
function range(a, b, step = 1) {
  ...
  if (shouldReverse) out2 = reverse(out2);
  return out2;
}
...
function dfAppend(df, x, axis) {
  ...
  if (isArray(x)) {
    ...
    if (axis === 0) {
      ...
      out2._columns = out2._columns.concat(
        x._columns.filter((c) => out2._columns.indexOf(c) < 0)
      );
      while (out2._index.length < out2._values.length) {
      ...
      out2._columns = out2._columns.concat(
        x._columns.map((c) => c + (out2._columns.indexOf(c) > -1 ? " (2)" : ""))
      );
      return out2;
    }
  } else {
...
function dfDrop(DataFrame2, Series2, df, rows, cols) {
  ...
  if (out2 instanceof Series2) {
    ...
    if (df.index.indexOf(out2.name) > -1) temp = temp.transpose();
    out2 = temp;
  }
  return out2;
}
...
function dfDropNaN(DataFrame2, df, axis, condition, threshold) {
  ...
  if (axis === 0) {
    ...
    if (rowsToKeep.length > 0) return out2.get(rowsToKeep, null);
    ...
    if (colsToKeep.length > 0) return out2.get(null, colsToKeep);
    else return new DataFrame2();
  }
  return out2;
}
...
function leftPad(x, maxLength) {
  ...
  let out2 = x.toString();
  while (out2.length < maxLength) out2 = "0" + out2;
  return out2;
}
...
function splitmix64(state, n) {
  ...
  const out2 = [];
  for (let i = 0; i < n; i++) out2.push(helper5());
  return out2;
}
function uint(x) {
...
function seriesFilter(Series2, series, fn) {
  ...
  const newValues = out2.values.filter((value, i) => {
    ...
    if (!shouldKeep) indicesToRemove.push(out2.index[i]);
    return shouldKeep;
  });
...
function makeKey3(n) {
  ...
  let out2 = "";
  for (let i = 0; i < n; i++) out2 += alpha[Math.floor(random() * alpha.length)];
  return out2;
}
var DataFrame = class _DataFrame {
  ...
  clear() {
    const out2 = new _DataFrame(ndarray(this.shape));
  ...
  transpose() {
    const out2 = new _DataFrame(transpose(this.values));
...
// node_modules/@jrc03c/js-math-tools/src/combinations.mjs
...
// node_modules/@jrc03c/js-math-tools/src/diff.mjs
function diff(a, b) {
...
// node_modules/@jrc03c/js-math-tools/src/distance.mjs
...
// node_modules/@jrc03c/js-math-tools/src/drop-missing.mjs
...
// node_modules/@jrc03c/js-math-tools/src/drop-missing-pairwise.mjs
...
// node_modules/@jrc03c/js-math-tools/src/drop-undefined.mjs
...
// node_modules/@jrc03c/js-math-tools/src/find.mjs
function find(x, fn) {
  if (isDataFrame(x)) {
...
// node_modules/@jrc03c/js-math-tools/src/find-all.mjs
...
function zeros(shape2) {
  ...
  for (let i = 0; i < n; i++) out2.push(0);
  return reshape(out2, shape2);
}

// node_modules/@jrc03c/js-math-tools/src/identity.mjs
function identity(size) {
  ...
  for (let i = 0; i < size; i++) out2[i][i] = 1;
  return out2;
}
...
// node_modules/@jrc03c/js-math-tools/src/inverse.mjs
function inverse(x) {
  if (isDataFrame(x)) {
    const out2 = x.copy();
...
// node_modules/@jrc03c/js-math-tools/src/helpers/is-browser.mjs
...
// node_modules/@jrc03c/js-math-tools/src/median.mjs
...
// node_modules/@jrc03c/js-math-tools/src/mode.mjs
...
// node_modules/@jrc03c/js-math-tools/src/ones.mjs
function ones(shape2) {
  return vapply(ndarray(shape2), () => 1);
}

// node_modules/@jrc03c/js-math-tools/src/permutations.mjs
...
// node_modules/@jrc03c/js-math-tools/src/print.mjs
function print() {
...
// node_modules/@jrc03c/js-math-tools/src/some.mjs
function some(x, fn) {
  if (isDataFrame(x) || isSeries(x)) {
...
// node_modules/@jrc03c/js-math-tools/src/std.mjs
function std(arr, shouldDropNaNs) {
  return stats(arr, { shouldDropNaNs, stdev: true }).stdev;
}

// node_modules/@jrc03c/js-math-tools/src/stdev.mjs
function stdev(x) {
  return std(x);
}
...
// node_modules/@jrc03c/js-math-tools/src/time.mjs
...
// node_modules/@jrc03c/js-math-tools/src/union.mjs
function union() {
  return set(
    [...arguments].map((v) => {
...
// node_modules/@jrc03c/js-math-tools/src/variance.mjs
function variance(arr, shouldDropNaNs) {
  return stats(arr, { shouldDropNaNs, variance: true }).variance;
}

// node_modules/@jrc03c/js-math-tools/src/zip.mjs
function zip() {
  const out2 = [];
...
// node_modules/@jrc03c/js-math-tools/src/index.mjs
var out = {
  abs: vabs,
  add: vadd,
  apply: vapply,
