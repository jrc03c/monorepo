...
__export(src_exports, {
  ...
  defineTypedProperty: () => defineTypedProperty,
  isOfType: () => isOfType
});
...
var TypedArray = class _TypedArray extends Array {
  ...
  canAccept(value) {
    ...
    ) || isArray2(value) && (value instanceof this.constructor || flatten2(value).every((v) => this.canAccept(v)));
  }
  challenge(value) {
