(() => {
  ...
  !(async () => {
    ...
    const result = await helper4.exec("some-long-operation", x, (p) => {
      progressBar.value = p;
    ...
    try {
      await helper4.exec("throw-an-error");
    } catch (e) {
