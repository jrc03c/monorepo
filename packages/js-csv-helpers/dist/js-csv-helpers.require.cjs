    ...
    (function(root, factory) {
      ...
      if (global2.jQuery) {
        ...
        $.fn.parse = function(options) {
            ...
            if (isFunction3(options.before)) {
              ...
              if (typeof returned === "object") {
                if (returned.action === "abort") {
                  error3("AbortError", f.file, f.inputElem, returned.reason);
                  return;
          ...
          function error3(name, file, elem, reason) {
      ...
      function ChunkStreamer(config) {
        ...
        this._sendError = function(error3) {
          if (isFunction3(this._config.error))
            this._config.error(error3);
      ...
      function ReadableStreamStreamer(config) {
        ...
        this._streamData = bindFunction(function(chunk) {
          try {
            ...
            this._streamError(error3);
          }
        }, this);
        this._streamError = bindFunction(function(error3) {
          this._streamCleanUp();
          this._sendError(error3);
        }, this);
        ...
        this.parse = function(input, baseIndex, ignoreLastRow) {
          ...
          if (config.header && !baseIndex) {
            ...
            for (var j in headers) {
              ...
              var count3 = headerCount[header] || 0;
              if (count3 > 0) {
                duplicateHeaders = true;
                headerName = header + separator + count3;
              }
              headerCount[header] = count3 + 1;
              while (headerMap.includes(headerName)) {
                headerName = headerName + separator + count3;
              }
