var f=Object.defineProperty;var z=Object.getOwnPropertyDescriptor;var b=Object.getOwnPropertyNames;var B=Object.prototype.hasOwnProperty;var _=(e,t)=>{for(var i in t)f(e,i,{get:t[i],enumerable:!0})},C=(e,t,i,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of b(t))!B.call(e,n)&&n!==i&&f(e,n,{get:()=>t[n],enumerable:!(s=z(t,n))||s.enumerable});return e};var L=e=>C(f({},"__esModule",{value:!0}),e);var X={};_(X,{ContextMenuComponent:()=>g,DraggableComponent:()=>l,FrameComponent:()=>v,MenuComponent:()=>p,ResizeableComponent:()=>x});module.exports=L(X);function d(e){let t=0,i;e=e||{};let s=e.data?e.data:function(){},n=e.mounted?e.mounted:function(){},o=e.unmounted?e.unmounted:function(){};return s.css||(s.css=""),e.data=function(){return s.bind(this)()},e.mounted=function(){n.bind(this)(),t++;let h=this.$root.$el.getRootNode();h===document&&(h=h.body),i||(i=document.createElement("style"),h.appendChild(i),i.innerHTML=this.css)},e.unmounted=function(){o.bind(this)(),t--;let h=this.$root.$el.getRootNode();if(h===document&&(h=h.body),t<1){if(i)try{h.removeChild(i)}catch{try{i.parentElement.removeChild(i)}catch{}}i=null}},e}typeof window<"u"&&(window.createVueComponentWithCSS=d);function m(e){return new Promise((t,i)=>{try{let s=new Date;return setTimeout(()=>t(new Date-s),e)}catch(s){return i(s)}})}function D(e){let t=new Date,i=new Date;for(;i-t<e;)i=new Date;return new Date-t}typeof window<"u"&&(window.pause=m,window.pauseAsync=m,window.pauseSync=D);var R=`
  .x-context-menu {
    z-index: 999999999;
...
`;function E(e){let t=0;return e.forEach(i=>t+=i),t}var w=d({name:"x-frame-horizontal",template:M,emits:["resize","resize-end","resize-start"],props:{"is-locked":{type:Boolean,required:!1,default:()=>!1},"max-width":{type:Number,required:!1,default:()=>1/0},"min-width":{type:Number,required:!1,default:()=>64}},data(){return{activeDividerIndex:0,css:H,isAddingDividers:!1,isBeingResized:!1,mouse:{x:0},observer:null,widths:[]}},methods:{onMouseDown(e,t){if(this.isLocked)return;this.isBeingResized=!0,this.activeDividerIndex=t;let i=Array.from(this.$el.children).filter(o=>!o.classList.contains("x-frame-divider")),s=i[this.activeDividerIndex],n=i[this.activeDividerIndex+1];this.$emit("resize-start",[s,n])},onMouseMove(e){let t,i;if(!this.isLocked&&this.isBeingResized){let s=e.pageX-this.mouse.x,n=[],o=[];Array.from(this.$el.children).forEach(r=>{r.classList.contains("x-frame-divider")?n.push(r):o.push(r)});let h=o[this.activeDividerIndex],a=o[this.activeDividerIndex+1];t=h,i=a;let c=h.getBoundingClientRect(),u=a.getBoundingClientRect();if(this.widths[this.activeDividerIndex]=c.width+s,this.widths[this.activeDividerIndex+1]=u.width-s,this.widths[this.activeDividerIndex]<this.minWidth){let r=this.widths[this.activeDividerIndex]-this.minWidth;this.widths[this.activeDividerIndex]-=r,this.widths[this.activeDividerIndex+1]+=r}if(this.widths[this.activeDividerIndex]>this.maxWidth){let r=this.widths[this.activeDividerIndex]-this.maxWidth;this.widths[this.activeDividerIndex]-=r,this.widths[this.activeDividerIndex+1]+=r}if(this.widths[this.activeDividerIndex+1]<this.minWidth){let r=this.widths[this.activeDividerIndex+1]-this.minWidth;this.widths[this.activeDividerIndex+1]-=r,this.widths[this.activeDividerIndex]+=r}if(this.widths[this.activeDividerIndex+1]>this.maxWidth){let r=this.widths[this.activeDividerIndex+1]-this.maxWidth;this.widths[this.activeDividerIndex+1]-=r,this.widths[this.activeDividerIndex]+=r}this.updateStyles()}this.mouse.x=e.pageX,this.isLocked||this.$emit("resize",[t,i])},onMouseUp(){if(this.isLocked)return;let e=this.isBeingResized;if(this.isBeingResized=!1,e){let t=Array.from(this.$el.children).filter(n=>!n.classList.contains("x-frame-divider")),i=t[this.activeDividerIndex],s=t[this.activeDividerIndex+1];this.$emit("resize-end",[i,s])}},onMutation(){this.isAddingDividers||(this.isAddingDividers=!0,Array.from(this.$el.children).forEach(e=>{e.classList.contains("x-frame-divider")&&this.$el.removeChild(e)}),Array.from(this.$el.children).slice(1).forEach((e,t)=>{let i=document.createElement("div");i.classList.add("x-frame-divider"),this.$el.insertBefore(i,e);let s=document.createElement("div");s.classList.add("x-frame-divider-inner"),i.appendChild(s),i.addEventListener("mousedown",n=>{this.onMouseDown(n,t)})}),this.$nextTick(()=>{this.updateStyles(),this.isAddingDividers=!1}))},updateStyles(){let e=this.$el.getBoundingClientRect(),t=[],i=[];Array.from(this.$el.children).forEach(n=>{n.classList.contains("x-frame-divider")?t.push(n):i.push(n)});let s=e.width-E(t.map(n=>n.getBoundingClientRect().width));i.forEach((n,o)=>{let h=this.widths[o]||s/i.length;this.widths[o]=h,n.style.width=`${h}px`})}},mounted(){this.observer=new MutationObserver(this.onMutation),this.observer.observe(this.$el,{childList:!0}),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mouseup",this.onMouseUp),this.$nextTick(()=>{this.onMutation(),this.widths=Array.from(this.$el.children).filter(e=>!e.classList.contains("x-frame-divider")).map(e=>e.getBoundingClientRect().width),this.updateStyles()})},unmounted(){this.observer.disconnect(),window.removeEventListener("mousemove",this.onMouseMove),window.removeEventListener("mouseup",this.onMouseUp)}});var W=`
  .x-frame {
    width: 100%;
    height: 100%;
    display: flex;
...
`,v=d({name:"x-frame",template:A,emits:["resize","resize-end","resize-start"],components:{"x-frame-horizontal":w,"x-frame-vertical":y},props:{"is-locked":{type:Boolean,required:!1,default:()=>!1},"max-size":{type:Number,required:!1,default:()=>1/0},"min-size":{type:Number,required:!1,default:()=>64},orientation:{type:String,required:!1,default:()=>"horizontal"}},data(){return{css:q}}});var P="",T="",p=d({name:"x-menu",template:T,data(){return{css:P}}});var O=`
  .no-pointer-events,
  .no-pointer-events * {
    pointer-events: none;
  }
