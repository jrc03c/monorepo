...
`
  ...
  var ContextMenuComponent = createVueComponentWithCSS({
    name: "x-context-menu",
    template,
...
`
  ...
  var DraggableComponent = createVueComponentWithCSS({
    name: "x-draggable",
    template: template2,
...
`
  ...
  var FrameHorizontalComponent = createVueComponentWithCSS({
...
`
  ...
  var FrameVerticalComponent = createVueComponentWithCSS({
    ...
    methods: {
      ...
      updateStyles() {
        ...
        const parentHeight = parentRect.height - sum2(dividers.map((d) => d.getBoundingClientRect().height));
        nonDividers.forEach((child, i) => {
...
`
  ...
  var FrameComponent = createVueComponentWithCSS({
    name: "x-frame",
    template: template5,
    emits: ["resize", "resize-end", "resize-start"],
    components: {
  ...
  var MenuComponent = createVueComponentWithCSS({
    name: "x-menu",
    template: template6,
    data() {
      return {
...
`
  ...
  var ResizeableComponent = createVueComponentWithCSS({
    name: "x-resizeable",
    template: template7,
    emits: [
      "drag-end",
